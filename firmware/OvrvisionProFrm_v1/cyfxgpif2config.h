...
#ifndef _INCLUDED_IMAGESENSORINTERFACE_CYDSN_
#define _INCLUDED_IMAGESENSORINTERFACE_CYDSN_
#include "cyu3types.h"
#include "cyu3gpif.h"
...
uint16_t CyFxGpifTransition[]  = {
    0x0000, 0x1111, 0xAAAA, 0x8888, 0x5555, 0x3333
};
...
CyU3PGpifWaveData CyFxGpifWavedata[]  = {
    ...
    {{0x2E738902,0x00000100,0x800000A0},{0x00000000,0x00000000,0x00000000}},
    {{0x3E728903,0x20000108,0x80000060},{0x00000000,0x00000000,0x00000000}},
    {{0x3E726904,0x24000108,0x80000090},{0x4E739405,0x00000004,0x80000000}},
    {{0x3E728903,0x20000108,0x80000060},{0x4E739306,0x00000004,0x80000000}},
    {{0x2E714907,0x0000010A,0x80000000},{0x2E714908,0x0000010A,0x80000000}},
    {{0x2E714909,0x0000010A,0x80000000},{0x2E71490A,0x0000010A,0x80000000}},
    {{0x3E728903,0x20000108,0x80000060},{0x0000000B,0x00000000,0x80000100}},
    {{0x3E726904,0x24000108,0x80000090},{0x0000000D,0x00000000,0x80000100}},
    {{0x3E726904,0x24000108,0x80000090},{0x0000000C,0x00000000,0x80000100}},
    {{0x3E728903,0x20000108,0x80000060},{0x0000000E,0x00000000,0x80000100}},
...
uint32_t CyFxGpifRegValue[]  = {
    ...
    0x00010000,  /*  CY_U3P_PIB_GPIF_CTRL_BUS_DIRECTION */
    0x0000E0FF,  /*  CY_U3P_PIB_GPIF_CTRL_BUS_DEFAULT */
...
#endif   /* _INCLUDED_IMAGESENSORINTERFACE_CYDSN_ */
