Shader "RedDotGames/Car Paint DuoColor" {
   Properties {
   
	  _Color ("Diffuse Material Color (RGB)", Color) = (1,1,1,1) 
	  _Color2 ("Diffuse Material Color2 (RGB)", Color) = (1,0,1,1) 
...
void main ()
{
  ...
  tmpvar_20 = reflect (xlv_TEXCOORD4, tmpvar_2);
  ...
  tmpvar_25 = (tmpvar_21.xyz * (_Reflection + tmpvar_24));
  reflTex.xyz = tmpvar_25;
  highp vec4 tmpvar_26;
  tmpvar_26 = (pow (SurfAngle, _duoPower) * _Color2);
  duoColor = tmpvar_26;
  highp vec4 tmpvar_27;
  tmpvar_27.w = 1.0;
  tmpvar_27.xyz = ((textureColor.xyz * clamp ((((xlv_TEXCOORD2 + duoColor.xyz) + tmpvar_7) + tmpvar_8), 0.0, 1.0)) + tmpvar_11);
  color = tmpvar_27;
  highp vec4 tmpvar_28;
  tmpvar_28 = (color + (paintColor * _FlakePower));
  color = tmpvar_28;
  color = ((color + reflTex) + (tmpvar_24 * reflTex));
  color.w = _Color.w;
  tmpvar_1 = color;
...
void main ()
{
  ...
  tmpvar_24 = clamp (abs (dot (reflectedDir, xlv_TEXCOORD1)), 0.0, 1.0);
  SurfAngle = tmpvar_24;
  ...
  tmpvar_27 = (tmpvar_23.xyz * (_Reflection + tmpvar_26));
  reflTex.xyz = tmpvar_27;
  highp vec4 tmpvar_28;
  tmpvar_28 = (pow (SurfAngle, _duoPower) * _Color2);
  duoColor = tmpvar_28;
  highp vec4 tmpvar_29;
  tmpvar_29.w = 1.0;
  tmpvar_29.xyz = ((textureColor.xyz * clamp ((((xlv_TEXCOORD2 + duoColor.xyz) + tmpvar_9) + tmpvar_10), 0.0, 1.0)) + tmpvar_13);
  color = tmpvar_29;
...
"3.0-!!ARBfp1.0
# 99 ALU, 3 TEX
PARAM c[21] = { state.lightmodel.ambient,
		program.local[1..18],
		{ 2, 1, 0, 20 },
		{ 0, 4 } };
TEMP R0;
...
MUL R3.xyz, R0.w, R3;
MUL R0.xyz, R1, -R2.w;
MAD R0.xyz, -R0, c[19].x, -R2;
DP3 R0.x, R0, R3;
MAX R0.x, R0, c[19].z;
POW R0.y, R0.x, c[7].x;
SLT R0.x, R2.w, c[19].z;
MOV R2.xyz, c[6];
ABS R0.x, R0;
MUL R2.xyz, R2, c[18];
...
MAD R8.xyz, R3, c[19].x, -c[19].y;
DP3 R0.w, R1, fragment.texcoord[4];
MUL R3.xyz, R1, R0.w;
MAD R5.xyz, -R3, c[19].x, fragment.texcoord[4];
DP3 R0.w, R5, fragment.texcoord[1];
ABS_SAT R0.w, R0;
MUL R2.xyz, R2, R0.y;
CMP R0.x, -R0, c[19].z, c[19].y;
CMP R0.xyz, -R0.x, R2, c[19].z;
MUL R7.xyz, R0, c[8].x;
MOV R0.xyz, fragment.texcoord[6];
MUL R2.xyz, fragment.texcoord[1].zxyw, R0.yzxw;
MAD R2.xyz, fragment.texcoord[1].yzxw, R0.zxyw, -R2;
MOV R0.y, R2.z;
ADD R4.xyz, R8, c[19].zzyw;
MOV R1.y, R2;
...
DP3 R2.x, R3, -R4;
POW R3.w, R0.w, c[13].x;
DP3 R1.w, R2, R2;
MUL R4.xyz, R3.w, c[4];
ADD R6.xyz, fragment.texcoord[2], R4;
MOV R4.xyz, c[3];
MAD R6.xyz, R4, c[0], R6;
RSQ R1.w, R1.w;
MUL R4.xyz, R4, c[18];
MAX R2.w, R2, c[19].z;
MAD_SAT R6.xyz, R4, R2.w, R6;
TEX R4.xyz, fragment.texcoord[3], texture[0], 2D;
MAD R4.xyz, R4, R6, R7;
ADD R6.xyz, R8, c[20].xxyw;
DP3 R0.z, R0, -R6;
DP3 R0.y, -R6, R1;
DP3 R0.x, -R6, R3;
...
dcl_2d s1
dcl_cube s2
def c19, 2.00000000, 1.00000000, 0.00000000, 20.00000000
def c20, 2.00000000, -1.00000000, 0.00000000, 4.00000000
...
mul r1.xyz, r1, r1.w
abs_pp r0.w, r0
cmp r1.xyz, -r0.w, r1, c19.z
dp3 r0.w, r0, v4
mul r0.xyz, r0, r0.w
mul r8.xyz, r1, c8.x
mad r0.xyz, -r0, c19.x, v4
dp3_pp r0.w, r0, v1
abs_pp_sat r0.w, r0
pow_pp r5, r0.w, c13.x
mov r1.xyz, v6
mad r1.xyz, v1.yzxw, r1.zxyw, -r2
mul r2.xy, v3, c9.x
mul r2.xy, r2, c19.w
texld r2.xyz, r2, s1
mad r9.xyz, r2, c20.x, c20.y
mov_pp r3.w, r5.x
mul_pp r5.xyz, r3.w, c4
add r7.xyz, v2, r5
mov r5.xyz, c18
mov r4.y, r1.z
add r6.xyz, r9, c20.zzww
mov r3.y, r1
mov r2.y, r1.x
mov r4.x, v6.z
mov r4.z, v5
...
mul r5.xyz, c3, r5
mad r6.xyz, c3, r6, r7
mad_sat r6.xyz, r5, r2.w, r6
texld r5.xyz, v3, s0
mad r5.xyz, r5, r6, r8
add r6.xyz, r9, c19.zzyw
dp3 r4.z, r4, -r6
dp3 r4.x, r2, -r6
rsq r1.w, r1.w
mul r2.xyz, r1.w, v4
...
pow r2, r1.y, c11.x
mov r2.w, r1.x
add_pp r0.w, -r0, c19.y
pow_pp r1, r0.w, c17.x
mov_pp r0.w, r1.x
mul r2.xyz, r2.x, c15
mad r2.xyz, r2.w, c14, r2
mul r1.xyz, r2, c10.x
...
MAD R0.xyz, -R0, c[19].x, -R2;
DP3 R0.x, R0, R3;
SLT R0.y, R2.w, c[19].z;
MAX R0.x, R0, c[19].z;
POW R0.z, R0.x, c[7].x;
TXP R0.x, fragment.texcoord[7], texture[1], 2D;
MUL R6.xyz, R0.x, c[18];
MUL R2.xyz, R6, c[6];
ABS R0.x, R0.y;
MUL R3.xy, fragment.texcoord[3], c[9].x;
MUL R3.xy, R3, c[19].w;
TEX R3.xyz, R3, texture[2], 2D;
MAD R9.xyz, R3, c[19].x, -c[19].y;
DP3 R0.w, R1, fragment.texcoord[4];
MUL R3.xyz, R1, R0.w;
MAD R5.xyz, -R3, c[19].x, fragment.texcoord[4];
DP3 R0.w, R5, fragment.texcoord[1];
...
DP3 R1.w, R2, R2;
MUL R4.xyz, R3.w, c[4];
ADD R7.xyz, fragment.texcoord[2], R4;
RSQ R1.w, R1.w;
MOV R4.xyz, c[3];
MUL R2.xyz, R1.w, R2;
MAD R4.xyz, R4, c[0], R7;
MAX R2.w, R2, c[19].z;
MUL R6.xyz, R6, c[3];
MAD_SAT R6.xyz, R6, R2.w, R4;
TEX R4.xyz, fragment.texcoord[3], texture[0], 2D;
MAD R4.xyz, R4, R6, R8;
ADD R6.xyz, R9, c[20].xxyw;
DP3 R0.z, R0, -R6;
DP3 R0.y, -R6, R1;
DP3 R0.x, -R6, R3;
DP3 R1.x, R0, R0;
...
mov r1.xyz, v6
mad r7.xyz, v1.yzxw, r1.zxyw, -r2
mul r1.xy, v3, c9.x
mul r1.xy, r1, c19.w
texld r1.xyz, r1, s2
mad r6.xyz, r1, c20.x, c20.y
mad r1.xyz, -r0, c19.x, v4
dp3_pp r0.x, r1, v1
abs_pp_sat r1.w, r0.x
pow_pp r0, r1.w, c13.x
mov r3.y, r7.z
add r9.xyz, r6, c20.zzww
mov r2.y, r7
mov r3.x, v6.z
mov r3.z, v5
dp3 r7.z, r3, -r9
...
mad r0.xyz, c3, r0, r9
mul r4.xyz, r4, c3
mad_sat r4.xyz, r4, r2.w, r0
texld r0.xyz, v3, s0
mad r0.xyz, r0, r4, r5
add r4.xyz, r6, c19.zzyw
dp3 r3.z, r3, -r4
rsq r0.w, r0.w
mul r5.xyz, r0.w, r7
dp3 r0.w, v4, v4
