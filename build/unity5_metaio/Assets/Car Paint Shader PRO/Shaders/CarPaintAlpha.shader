Shader "RedDotGames/Car Paint Alpha" {
   Properties {
...
Program "fp" {
// Fragment combos: 6
//   opengl - ALU: 96 to 97, TEX: 3 to 4
//   d3d9 - ALU: 101 to 102, TEX: 3 to 4
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
...
MAD R7.xyz, R1, c[17].x, -c[17].y;
MOV R3.y, R0.z;
ADD R5.xyz, R7, c[18].xxyw;
MOV R2.y, R0;
MOV R1.y, R0.x;
...
DP3_SAT R0.w, R0, R8;
MOV R0.xyz, c[3];
MAD R5.xyz, R0, c[0], fragment.texcoord[2];
MUL R0.w, R0, R0;
MAX R1.w, R1, c[17].z;
MUL R0.xyz, R0, c[16];
MAD_SAT R5.xyz, R0, R1.w, R5;
TEX R0.xyz, fragment.texcoord[3], texture[0], 2D;
MAD R0.xyz, R0, R5, R6;
ADD R5.xyz, R7, c[17].zzyw;
DP3 R3.z, R3, -R5;
DP3 R3.x, R1, -R5;
DP3 R3.y, R2, -R5;
DP3 R1.y, R3, R3;
...
MUL R1.xyz, R4, R1.x;
MAD R1.xyz, -R1, c[17].x, fragment.texcoord[4];
...
dcl_2d s1
dcl_cube s2
def c17, 2.00000000, 1.00000000, 0.00000000, 20.00000000
...
rsq r0.w, r0.w
mul r5.xyz, r0.w, r5
cmp r0.w, r1, c17.z, c17.y
rsq r2.w, r2.w
mul r7.xyz, r2.w, v4
dp3_sat r2.w, r5, r7
abs_pp r0.w, r0
cmp r0.xyz, -r0.w, r0, c17.z
add r6.xyz, r6, c17.zzyw
mul r2.w, r2, r2
mul r5.xyz, r0, c7.x
pow r0, r2.w, c11.x
mov r0.yzw, c16.xxyz
...
dp3 r1.x, r4, v4
mul r1.xyz, r4, r1.x
mad r1.xyz, -r1, c17.x, v4
dp3_pp r0.x, r1, v1
abs_pp_sat r0.x, r0
add_pp r0.x, -r0, c17.y
mov r0.y, r2.x
pow_pp r2, r0.x, c15.x
mul r0.xyz, r0.y, c13
mad r3.xyz, r0.w, c12, r0
mov_pp r0.x, r2
...
max r1.w, r1, c17.z
mul r5.xyz, r5, c3
mad r0.yzw, c3.xxyz, r0, v2.xxyz
mad_sat r0.yzw, r5.xxyz, r1.w, r0
texld r5.xyz, v3, s0
mad r5.xyz, r5, r0.yzww, r6
add r6.xyz, r7, c17.zzyw
dp3 r0.y, r1, -r6
mov r0.w, r0.x
dp3 r0.z, r3, -r6
dp3 r0.x, r2, -r6
