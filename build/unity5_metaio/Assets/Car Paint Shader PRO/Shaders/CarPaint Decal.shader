Shader "RedDotGames/Car Paint Decal" {
   Properties {
...
void main ()
{
  ...
  tmpvar_30.w = 1.0;
  tmpvar_30.xyz = ((textureColor.xyz * clamp (((xlv_TEXCOORD2 + tmpvar_11) + tmpvar_12), 0.0, 1.0)) + tmpvar_15);
  color = tmpvar_30;
...
mul r0.y, r1.w, c12.x
add r1.xyz, r1, -r9
mad r1.xyz, r0.y, r1, r9
mov r9.xyz, c0
mov r0.yzw, c17.xxyz
mul r0.yzw, c3.xxyz, r0
max r1.w, r2, c18.z
mad r9.xyz, c3, r9, v2
mad_sat r9.xyz, r0.yzww, r1.w, r9
mad r1.xyz, r1, r9, r6
...
dp3_pp r0.x, r2, v1
abs_pp r0.x, r0
add_pp r0.x, -r0, c18.y
mov r0.y, r3.x
pow_pp r3, r0.x, c16.x
mul r0.xyz, r0.y, c14
mad r4.xyz, r0.w, c13, r0
mov_pp r0.x, r3
mul_pp r0.w, r0.x, c15.x
mul r3.xyz, r4, c9.x
add_pp r3.xyz, r1, r3
add_sat r1.x, r0.w, c4
texld r0.xyz, r2, s3
