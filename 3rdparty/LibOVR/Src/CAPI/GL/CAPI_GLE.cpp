...
//{
    ...
    #define GLELoadProc(var, name, taka) var = (taka)GLEGetProcAddress(#name)
    ...
    void OVR::GLEContext::InitExtensionLoad()
    {
        ...
        // GL_VERSION_1_2
        GLELoadProc(glCopyTexSubImage3D_Impl, glCopyTexSubImage3D, PFNGLCOPYTEXSUBIMAGE3DPROC);  // This expands to a get proc address call (e.g. wglGetProcAddress on Windows).
        GLELoadProc(glDrawRangeElements_Impl, glDrawRangeElements, PFNGLDRAWRANGEELEMENTSPROC);
        GLELoadProc(glTexImage3D_Impl, glTexImage3D, PFNGLTEXIMAGE3DPROC);
        GLELoadProc(glTexSubImage3D_Impl, glTexSubImage3D, PFNGLTEXSUBIMAGE3DPROC);

        // GL_VERSION_1_3
        GLELoadProc(glActiveTexture_Impl, glActiveTexture, PFNGLACTIVETEXTUREPROC);
        GLELoadProc(glClientActiveTexture_Impl, glClientActiveTexture, PFNGLCLIENTACTIVETEXTUREPROC);
        GLELoadProc(glCompressedTexImage1D_Impl, glCompressedTexImage1D, PFNGLCOMPRESSEDTEXIMAGE1DPROC);
        GLELoadProc(glCompressedTexImage2D_Impl, glCompressedTexImage2D, PFNGLCOMPRESSEDTEXIMAGE2DPROC);
        GLELoadProc(glCompressedTexImage3D_Impl, glCompressedTexImage3D, PFNGLCOMPRESSEDTEXIMAGE3DPROC);
        GLELoadProc(glCompressedTexSubImage1D_Impl, glCompressedTexSubImage1D, PFNGLCOMPRESSEDTEXSUBIMAGE1DPROC);
        GLELoadProc(glCompressedTexSubImage2D_Impl, glCompressedTexSubImage2D, PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC);
        GLELoadProc(glCompressedTexSubImage3D_Impl, glCompressedTexSubImage3D, PFNGLCOMPRESSEDTEXSUBIMAGE3DPROC);
        GLELoadProc(glGetCompressedTexImage_Impl, glGetCompressedTexImage, PFNGLGETCOMPRESSEDTEXIMAGEPROC);
        GLELoadProc(glLoadTransposeMatrixd_Impl, glLoadTransposeMatrixd, PFNGLLOADTRANSPOSEMATRIXDPROC);
        GLELoadProc(glLoadTransposeMatrixf_Impl, glLoadTransposeMatrixf, PFNGLLOADTRANSPOSEMATRIXFPROC);
        GLELoadProc(glMultTransposeMatrixd_Impl, glMultTransposeMatrixd, PFNGLMULTTRANSPOSEMATRIXDPROC);
        GLELoadProc(glMultTransposeMatrixf_Impl, glMultTransposeMatrixf, PFNGLMULTTRANSPOSEMATRIXFPROC);
        GLELoadProc(glMultiTexCoord1d_Impl, glMultiTexCoord1d, PFNGLMULTITEXCOORD1DPROC);
        GLELoadProc(glMultiTexCoord1dv_Impl, glMultiTexCoord1dv, PFNGLMULTITEXCOORD1DVPROC);
        GLELoadProc(glMultiTexCoord1f_Impl, glMultiTexCoord1f, PFNGLMULTITEXCOORD1FPROC);
        GLELoadProc(glMultiTexCoord1fv_Impl, glMultiTexCoord1fv, PFNGLMULTITEXCOORD1FVPROC);
        GLELoadProc(glMultiTexCoord1i_Impl, glMultiTexCoord1i, PFNGLMULTITEXCOORD1IPROC);
        GLELoadProc(glMultiTexCoord1iv_Impl, glMultiTexCoord1iv, PFNGLMULTITEXCOORD1IVPROC);
        GLELoadProc(glMultiTexCoord1s_Impl, glMultiTexCoord1s, PFNGLMULTITEXCOORD1SPROC);
        GLELoadProc(glMultiTexCoord1sv_Impl, glMultiTexCoord1sv, PFNGLMULTITEXCOORD1SVPROC);
        GLELoadProc(glMultiTexCoord2d_Impl, glMultiTexCoord2d, PFNGLMULTITEXCOORD2DPROC);
        GLELoadProc(glMultiTexCoord2dv_Impl, glMultiTexCoord2dv, PFNGLMULTITEXCOORD2DVPROC);
        GLELoadProc(glMultiTexCoord2f_Impl, glMultiTexCoord2f, PFNGLMULTITEXCOORD2FPROC);
        GLELoadProc(glMultiTexCoord2fv_Impl, glMultiTexCoord2fv, PFNGLMULTITEXCOORD2FVPROC);
        GLELoadProc(glMultiTexCoord2i_Impl, glMultiTexCoord2i, PFNGLMULTITEXCOORD2IPROC);
        GLELoadProc(glMultiTexCoord2iv_Impl, glMultiTexCoord2iv, PFNGLMULTITEXCOORD2IVPROC);
        GLELoadProc(glMultiTexCoord2s_Impl, glMultiTexCoord2s, PFNGLMULTITEXCOORD2SPROC);
        GLELoadProc(glMultiTexCoord2sv_Impl, glMultiTexCoord2sv, PFNGLMULTITEXCOORD2SVPROC);
        GLELoadProc(glMultiTexCoord3d_Impl, glMultiTexCoord3d, PFNGLMULTITEXCOORD3DPROC);
        GLELoadProc(glMultiTexCoord3dv_Impl, glMultiTexCoord3dv, PFNGLMULTITEXCOORD3DVPROC);
        GLELoadProc(glMultiTexCoord3f_Impl, glMultiTexCoord3f, PFNGLMULTITEXCOORD3FPROC);
        GLELoadProc(glMultiTexCoord3fv_Impl, glMultiTexCoord3fv, PFNGLMULTITEXCOORD3FVPROC);
        GLELoadProc(glMultiTexCoord3i_Impl, glMultiTexCoord3i, PFNGLMULTITEXCOORD3IPROC);
        GLELoadProc(glMultiTexCoord3iv_Impl, glMultiTexCoord3iv, PFNGLMULTITEXCOORD3IVPROC);
        GLELoadProc(glMultiTexCoord3s_Impl, glMultiTexCoord3s, PFNGLMULTITEXCOORD3SPROC);
        GLELoadProc(glMultiTexCoord3sv_Impl, glMultiTexCoord3sv, PFNGLMULTITEXCOORD3SVPROC);
        GLELoadProc(glMultiTexCoord4d_Impl, glMultiTexCoord4d, PFNGLMULTITEXCOORD4DPROC);
        GLELoadProc(glMultiTexCoord4dv_Impl, glMultiTexCoord4dv, PFNGLMULTITEXCOORD4DVPROC);
        GLELoadProc(glMultiTexCoord4f_Impl, glMultiTexCoord4f, PFNGLMULTITEXCOORD4FPROC);
        GLELoadProc(glMultiTexCoord4fv_Impl, glMultiTexCoord4fv, PFNGLMULTITEXCOORD4FVPROC);
        GLELoadProc(glMultiTexCoord4i_Impl, glMultiTexCoord4i, PFNGLMULTITEXCOORD4IPROC);
        GLELoadProc(glMultiTexCoord4iv_Impl, glMultiTexCoord4iv, PFNGLMULTITEXCOORD4IVPROC);
        GLELoadProc(glMultiTexCoord4s_Impl, glMultiTexCoord4s, PFNGLMULTITEXCOORD4SPROC);
        GLELoadProc(glMultiTexCoord4sv_Impl, glMultiTexCoord4sv, PFNGLMULTITEXCOORD4SVPROC);
        GLELoadProc(glSampleCoverage_Impl, glSampleCoverage, PFNGLSAMPLECOVERAGEPROC);

        // GL_VERSION_1_4
		GLELoadProc(glBlendColor_Impl,glBlendColor,PFNGLBLENDCOLORPROC);
		GLELoadProc(glBlendEquation_Impl,glBlendEquation,PFNGLBLENDEQUATIONPROC);
		GLELoadProc(glBlendFuncSeparate_Impl,glBlendFuncSeparate,PFNGLBLENDFUNCSEPARATEPROC);
		GLELoadProc(glFogCoordPointer_Impl,glFogCoordPointer,PFNGLFOGCOORDPOINTERPROC);
		GLELoadProc(glFogCoordd_Impl,glFogCoordd,PFNGLFOGCOORDDPROC);
		GLELoadProc(glFogCoorddv_Impl,glFogCoorddv,PFNGLFOGCOORDDVPROC);
		GLELoadProc(glFogCoordf_Impl,glFogCoordf,PFNGLFOGCOORDFPROC);
		GLELoadProc(glFogCoordfv_Impl,glFogCoordfv,PFNGLFOGCOORDFVPROC);
		GLELoadProc(glMultiDrawArrays_Impl,glMultiDrawArrays,PFNGLMULTIDRAWARRAYSPROC);
		GLELoadProc(glMultiDrawElements_Impl,glMultiDrawElements,PFNGLMULTIDRAWELEMENTSPROC);
		GLELoadProc(glPointParameterf_Impl,glPointParameterf,PFNGLPOINTPARAMETERFPROC);
		GLELoadProc(glPointParameterfv_Impl,glPointParameterfv,PFNGLPOINTPARAMETERFVPROC);
		GLELoadProc(glPointParameteri_Impl,glPointParameteri,PFNGLPOINTPARAMETERIPROC);
		GLELoadProc(glPointParameteriv_Impl,glPointParameteriv,PFNGLPOINTPARAMETERIVPROC);
		GLELoadProc(glSecondaryColor3b_Impl,glSecondaryColor3b,PFNGLSECONDARYCOLOR3BPROC);
		GLELoadProc(glSecondaryColor3bv_Impl,glSecondaryColor3bv,PFNGLSECONDARYCOLOR3BVPROC);
		GLELoadProc(glSecondaryColor3d_Impl,glSecondaryColor3d,PFNGLSECONDARYCOLOR3DPROC);
		GLELoadProc(glSecondaryColor3dv_Impl,glSecondaryColor3dv,PFNGLSECONDARYCOLOR3DVPROC);
		GLELoadProc(glSecondaryColor3f_Impl,glSecondaryColor3f,PFNGLSECONDARYCOLOR3FPROC);
		GLELoadProc(glSecondaryColor3fv_Impl,glSecondaryColor3fv,PFNGLSECONDARYCOLOR3FVPROC);
		GLELoadProc(glSecondaryColor3i_Impl,glSecondaryColor3i,PFNGLSECONDARYCOLOR3IPROC);
		GLELoadProc(glSecondaryColor3iv_Impl,glSecondaryColor3iv,PFNGLSECONDARYCOLOR3IVPROC);
		GLELoadProc(glSecondaryColor3s_Impl,glSecondaryColor3s,PFNGLSECONDARYCOLOR3SPROC);
		GLELoadProc(glSecondaryColor3sv_Impl,glSecondaryColor3sv,PFNGLSECONDARYCOLOR3SVPROC);
		GLELoadProc(glSecondaryColor3ub_Impl,glSecondaryColor3ub,PFNGLSECONDARYCOLOR3UBPROC);
		GLELoadProc(glSecondaryColor3ubv_Impl,glSecondaryColor3ubv,PFNGLSECONDARYCOLOR3UBVPROC);
		GLELoadProc(glSecondaryColor3ui_Impl,glSecondaryColor3ui,PFNGLSECONDARYCOLOR3UIPROC);
		GLELoadProc(glSecondaryColor3uiv_Impl,glSecondaryColor3uiv,PFNGLSECONDARYCOLOR3UIVPROC);
		GLELoadProc(glSecondaryColor3us_Impl,glSecondaryColor3us,PFNGLSECONDARYCOLOR3USPROC);
		GLELoadProc(glSecondaryColor3usv_Impl,glSecondaryColor3usv,PFNGLSECONDARYCOLOR3USVPROC);
		GLELoadProc(glSecondaryColorPointer_Impl,glSecondaryColorPointer,PFNGLSECONDARYCOLORPOINTERPROC);
		GLELoadProc(glWindowPos2d_Impl,glWindowPos2d,PFNGLWINDOWPOS2DPROC);
		GLELoadProc(glWindowPos2dv_Impl,glWindowPos2dv,PFNGLWINDOWPOS2DVPROC);
		GLELoadProc(glWindowPos2f_Impl,glWindowPos2f,PFNGLWINDOWPOS2FPROC);
		GLELoadProc(glWindowPos2fv_Impl,glWindowPos2fv,PFNGLWINDOWPOS2FVPROC);
		GLELoadProc(glWindowPos2i_Impl,glWindowPos2i,PFNGLWINDOWPOS2IPROC);
		GLELoadProc(glWindowPos2iv_Impl,glWindowPos2iv,PFNGLWINDOWPOS2IVPROC);
		GLELoadProc(glWindowPos2s_Impl,glWindowPos2s,PFNGLWINDOWPOS2SPROC);
		GLELoadProc(glWindowPos2sv_Impl,glWindowPos2sv,PFNGLWINDOWPOS2SVPROC);
		GLELoadProc(glWindowPos3d_Impl,glWindowPos3d,PFNGLWINDOWPOS3DPROC);
		GLELoadProc(glWindowPos3dv_Impl,glWindowPos3dv,PFNGLWINDOWPOS3DVPROC);
		GLELoadProc(glWindowPos3f_Impl,glWindowPos3f,PFNGLWINDOWPOS3FPROC);
		GLELoadProc(glWindowPos3fv_Impl,glWindowPos3fv,PFNGLWINDOWPOS3FVPROC);
		GLELoadProc(glWindowPos3i_Impl,glWindowPos3i,PFNGLWINDOWPOS3IPROC);
		GLELoadProc(glWindowPos3iv_Impl,glWindowPos3iv,PFNGLWINDOWPOS3IVPROC);
		GLELoadProc(glWindowPos3s_Impl,glWindowPos3s,PFNGLWINDOWPOS3SPROC);
		GLELoadProc(glWindowPos3sv_Impl,glWindowPos3sv,PFNGLWINDOWPOS3SVPROC);

		//GL_VERSION_1_5
		GLELoadProc(glBeginQuery_Impl,glBeginQuery,PFNGLBEGINQUERYPROC);
		GLELoadProc(glBindBuffer_Impl,glBindBuffer,PFNGLBINDBUFFERPROC);
		GLELoadProc(glBufferData_Impl,glBufferData,PFNGLBUFFERDATAPROC);
		GLELoadProc(glBufferSubData_Impl,glBufferSubData,PFNGLBUFFERSUBDATAPROC);
		GLELoadProc(glDeleteBuffers_Impl,glDeleteBuffers,PFNGLDELETEBUFFERSPROC);
		GLELoadProc(glDeleteQueries_Impl,glDeleteQueries,PFNGLDELETEQUERIESPROC);
		GLELoadProc(glEndQuery_Impl,glEndQuery,PFNGLENDQUERYPROC);
		GLELoadProc(glGenBuffers_Impl,glGenBuffers,PFNGLGENBUFFERSPROC);
		GLELoadProc(glGenQueries_Impl,glGenQueries,PFNGLGENQUERIESPROC);
		GLELoadProc(glGetBufferParameteriv_Impl,glGetBufferParameteriv,PFNGLGETBUFFERPARAMETERIVPROC);
		GLELoadProc(glGetBufferPointerv_Impl,glGetBufferPointerv,PFNGLGETBUFFERPOINTERVPROC);
		GLELoadProc(glGetBufferSubData_Impl,glGetBufferSubData,PFNGLGETBUFFERSUBDATAPROC);
		GLELoadProc(glGetQueryObjectiv_Impl,glGetQueryObjectiv,PFNGLGETQUERYOBJECTIVPROC);
		GLELoadProc(glGetQueryObjectuiv_Impl,glGetQueryObjectuiv,PFNGLGETQUERYOBJECTUIVPROC);
		GLELoadProc(glGetQueryiv_Impl,glGetQueryiv,PFNGLGETQUERYIVPROC);
		GLELoadProc(glIsBuffer_Impl,glIsBuffer,PFNGLISBUFFERPROC);
		GLELoadProc(glIsQuery_Impl,glIsQuery,PFNGLISQUERYPROC);
		GLELoadProc(glMapBuffer_Impl,glMapBuffer,PFNGLMAPBUFFERPROC);
		GLELoadProc(glUnmapBuffer_Impl,glUnmapBuffer,PFNGLUNMAPBUFFERPROC);
		//GL_VERSION_2_0
		GLELoadProc(glAttachShader_Impl,glAttachShader,PFNGLATTACHSHADERPROC);
		GLELoadProc(glBindAttribLocation_Impl,glBindAttribLocation,PFNGLBINDATTRIBLOCATIONPROC);
		GLELoadProc(glBlendEquationSeparate_Impl,glBlendEquationSeparate,PFNGLBLENDEQUATIONSEPARATEPROC);
		GLELoadProc(glCompileShader_Impl,glCompileShader,PFNGLCOMPILESHADERPROC);
		GLELoadProc(glCreateProgram_Impl,glCreateProgram,PFNGLCREATEPROGRAMPROC);
		GLELoadProc(glCreateShader_Impl,glCreateShader,PFNGLCREATESHADERPROC);
		GLELoadProc(glDeleteProgram_Impl,glDeleteProgram,PFNGLDELETEPROGRAMPROC);
		GLELoadProc(glDeleteShader_Impl,glDeleteShader,PFNGLDELETESHADERPROC);
		GLELoadProc(glDetachShader_Impl,glDetachShader,PFNGLDETACHSHADERPROC);
		GLELoadProc(glDisableVertexAttribArray_Impl,glDisableVertexAttribArray,PFNGLDISABLEVERTEXATTRIBARRAYPROC);
		GLELoadProc(glDrawBuffers_Impl,glDrawBuffers,PFNGLDRAWBUFFERSPROC);
		GLELoadProc(glEnableVertexAttribArray_Impl,glEnableVertexAttribArray,PFNGLENABLEVERTEXATTRIBARRAYPROC);
		GLELoadProc(glGetActiveAttrib_Impl,glGetActiveAttrib,PFNGLGETACTIVEATTRIBPROC);
		GLELoadProc(glGetActiveUniform_Impl,glGetActiveUniform,PFNGLGETACTIVEUNIFORMPROC);
		GLELoadProc(glGetAttachedShaders_Impl,glGetAttachedShaders,PFNGLGETATTACHEDSHADERSPROC);
		GLELoadProc(glGetAttribLocation_Impl,glGetAttribLocation,PFNGLGETATTRIBLOCATIONPROC);
		GLELoadProc(glGetProgramInfoLog_Impl,glGetProgramInfoLog,PFNGLGETPROGRAMINFOLOGPROC);
		GLELoadProc(glGetProgramiv_Impl,glGetProgramiv,PFNGLGETPROGRAMIVPROC);
		GLELoadProc(glGetShaderInfoLog_Impl,glGetShaderInfoLog,PFNGLGETSHADERINFOLOGPROC);
		GLELoadProc(glGetShaderSource_Impl,glGetShaderSource,PFNGLGETSHADERSOURCEPROC);
		GLELoadProc(glGetShaderiv_Impl,glGetShaderiv,PFNGLGETSHADERIVPROC);
		GLELoadProc(glGetUniformLocation_Impl,glGetUniformLocation,PFNGLGETUNIFORMLOCATIONPROC);
		GLELoadProc(glGetUniformfv_Impl,glGetUniformfv,PFNGLGETUNIFORMFVPROC);
		GLELoadProc(glGetUniformiv_Impl,glGetUniformiv,PFNGLGETUNIFORMIVPROC);
		GLELoadProc(glGetVertexAttribPointerv_Impl,glGetVertexAttribPointerv,PFNGLGETVERTEXATTRIBPOINTERVPROC);
		GLELoadProc(glGetVertexAttribdv_Impl,glGetVertexAttribdv,PFNGLGETVERTEXATTRIBDVPROC);
		GLELoadProc(glGetVertexAttribfv_Impl,glGetVertexAttribfv,PFNGLGETVERTEXATTRIBFVPROC);
		GLELoadProc(glGetVertexAttribiv_Impl,glGetVertexAttribiv,PFNGLGETVERTEXATTRIBIVPROC);
		GLELoadProc(glIsProgram_Impl,glIsProgram,PFNGLISPROGRAMPROC);
		GLELoadProc(glIsShader_Impl,glIsShader,PFNGLISSHADERPROC);
		GLELoadProc(glLinkProgram_Impl,glLinkProgram,PFNGLLINKPROGRAMPROC);
		GLELoadProc(glShaderSource_Impl,glShaderSource,PFNGLSHADERSOURCEPROC);
		GLELoadProc(glStencilFuncSeparate_Impl,glStencilFuncSeparate,PFNGLSTENCILFUNCSEPARATEPROC);
		GLELoadProc(glStencilMaskSeparate_Impl,glStencilMaskSeparate,PFNGLSTENCILMASKSEPARATEPROC);
		GLELoadProc(glStencilOpSeparate_Impl,glStencilOpSeparate,PFNGLSTENCILOPSEPARATEPROC);
		GLELoadProc(glUniform1f_Impl,glUniform1f,PFNGLUNIFORM1FPROC);
		GLELoadProc(glUniform1fv_Impl,glUniform1fv,PFNGLUNIFORM1FVPROC);
		GLELoadProc(glUniform1i_Impl,glUniform1i,PFNGLUNIFORM1IPROC);
		GLELoadProc(glUniform1iv_Impl,glUniform1iv,PFNGLUNIFORM1IVPROC);
		GLELoadProc(glUniform2f_Impl,glUniform2f,PFNGLUNIFORM2FPROC);
		GLELoadProc(glUniform2fv_Impl,glUniform2fv,PFNGLUNIFORM2FVPROC);
		GLELoadProc(glUniform2i_Impl,glUniform2i,PFNGLUNIFORM2IPROC);
		GLELoadProc(glUniform2iv_Impl,glUniform2iv,PFNGLUNIFORM2IVPROC);
		GLELoadProc(glUniform3f_Impl,glUniform3f,PFNGLUNIFORM3FPROC);
		GLELoadProc(glUniform3fv_Impl,glUniform3fv,PFNGLUNIFORM3FVPROC);
		GLELoadProc(glUniform3i_Impl,glUniform3i,PFNGLUNIFORM3IPROC);
		GLELoadProc(glUniform3iv_Impl,glUniform3iv,PFNGLUNIFORM3IVPROC);
		GLELoadProc(glUniform4f_Impl,glUniform4f,PFNGLUNIFORM4FPROC);
		GLELoadProc(glUniform4fv_Impl,glUniform4fv,PFNGLUNIFORM4FVPROC);
		GLELoadProc(glUniform4i_Impl,glUniform4i,PFNGLUNIFORM4IPROC);
		GLELoadProc(glUniform4iv_Impl,glUniform4iv,PFNGLUNIFORM4IVPROC);
		GLELoadProc(glUniformMatrix2fv_Impl,glUniformMatrix2fv,PFNGLUNIFORMMATRIX2FVPROC);
		GLELoadProc(glUniformMatrix3fv_Impl,glUniformMatrix3fv,PFNGLUNIFORMMATRIX3FVPROC);
		GLELoadProc(glUniformMatrix4fv_Impl,glUniformMatrix4fv,PFNGLUNIFORMMATRIX4FVPROC);
		GLELoadProc(glUseProgram_Impl,glUseProgram,PFNGLUSEPROGRAMPROC);
		GLELoadProc(glValidateProgram_Impl,glValidateProgram,PFNGLVALIDATEPROGRAMPROC);
		GLELoadProc(glVertexAttrib1d_Impl,glVertexAttrib1d,PFNGLVERTEXATTRIB1DPROC);
		GLELoadProc(glVertexAttrib1dv_Impl,glVertexAttrib1dv,PFNGLVERTEXATTRIB1DVPROC);
		GLELoadProc(glVertexAttrib1f_Impl,glVertexAttrib1f,PFNGLVERTEXATTRIB1FPROC);
		GLELoadProc(glVertexAttrib1fv_Impl,glVertexAttrib1fv,PFNGLVERTEXATTRIB1FVPROC);
		GLELoadProc(glVertexAttrib1s_Impl,glVertexAttrib1s,PFNGLVERTEXATTRIB1SPROC);
		GLELoadProc(glVertexAttrib1sv_Impl,glVertexAttrib1sv,PFNGLVERTEXATTRIB1SVPROC);
		GLELoadProc(glVertexAttrib2d_Impl,glVertexAttrib2d,PFNGLVERTEXATTRIB2DPROC);
		GLELoadProc(glVertexAttrib2dv_Impl,glVertexAttrib2dv,PFNGLVERTEXATTRIB2DVPROC);
		GLELoadProc(glVertexAttrib2f_Impl,glVertexAttrib2f,PFNGLVERTEXATTRIB2FPROC);
		GLELoadProc(glVertexAttrib2fv_Impl,glVertexAttrib2fv,PFNGLVERTEXATTRIB2FVPROC);
		GLELoadProc(glVertexAttrib2s_Impl,glVertexAttrib2s,PFNGLVERTEXATTRIB2SPROC);
		GLELoadProc(glVertexAttrib2sv_Impl,glVertexAttrib2sv,PFNGLVERTEXATTRIB2SVPROC);
		GLELoadProc(glVertexAttrib3d_Impl,glVertexAttrib3d,PFNGLVERTEXATTRIB3DPROC);
		GLELoadProc(glVertexAttrib3dv_Impl,glVertexAttrib3dv,PFNGLVERTEXATTRIB3DVPROC);
		GLELoadProc(glVertexAttrib3f_Impl,glVertexAttrib3f,PFNGLVERTEXATTRIB3FPROC);
		GLELoadProc(glVertexAttrib3fv_Impl,glVertexAttrib3fv,PFNGLVERTEXATTRIB3FVPROC);
		GLELoadProc(glVertexAttrib3s_Impl,glVertexAttrib3s,PFNGLVERTEXATTRIB3SPROC);
		GLELoadProc(glVertexAttrib3sv_Impl,glVertexAttrib3sv,PFNGLVERTEXATTRIB3SVPROC);
		GLELoadProc(glVertexAttrib4Nbv_Impl,glVertexAttrib4Nbv,PFNGLVERTEXATTRIB4NBVPROC);
		GLELoadProc(glVertexAttrib4Niv_Impl,glVertexAttrib4Niv,PFNGLVERTEXATTRIB4NIVPROC);
		GLELoadProc(glVertexAttrib4Nsv_Impl,glVertexAttrib4Nsv,PFNGLVERTEXATTRIB4NSVPROC);
		GLELoadProc(glVertexAttrib4Nub_Impl,glVertexAttrib4Nub,PFNGLVERTEXATTRIB4NUBPROC);
		GLELoadProc(glVertexAttrib4Nubv_Impl,glVertexAttrib4Nubv,PFNGLVERTEXATTRIB4NUBVPROC);
		GLELoadProc(glVertexAttrib4Nuiv_Impl,glVertexAttrib4Nuiv,PFNGLVERTEXATTRIB4NUIVPROC);
		GLELoadProc(glVertexAttrib4Nusv_Impl,glVertexAttrib4Nusv,PFNGLVERTEXATTRIB4NUSVPROC);
		GLELoadProc(glVertexAttrib4bv_Impl,glVertexAttrib4bv,PFNGLVERTEXATTRIB4BVPROC);
		GLELoadProc(glVertexAttrib4d_Impl,glVertexAttrib4d,PFNGLVERTEXATTRIB4DPROC);
		GLELoadProc(glVertexAttrib4dv_Impl,glVertexAttrib4dv,PFNGLVERTEXATTRIB4DVPROC);
		GLELoadProc(glVertexAttrib4f_Impl,glVertexAttrib4f,PFNGLVERTEXATTRIB4FPROC);
		GLELoadProc(glVertexAttrib4fv_Impl,glVertexAttrib4fv,PFNGLVERTEXATTRIB4FVPROC);
		GLELoadProc(glVertexAttrib4iv_Impl,glVertexAttrib4iv,PFNGLVERTEXATTRIB4IVPROC);
		GLELoadProc(glVertexAttrib4s_Impl,glVertexAttrib4s,PFNGLVERTEXATTRIB4SPROC);
		GLELoadProc(glVertexAttrib4sv_Impl,glVertexAttrib4sv,PFNGLVERTEXATTRIB4SVPROC);
		GLELoadProc(glVertexAttrib4ubv_Impl,glVertexAttrib4ubv,PFNGLVERTEXATTRIB4UBVPROC);
		GLELoadProc(glVertexAttrib4uiv_Impl,glVertexAttrib4uiv,PFNGLVERTEXATTRIB4UIVPROC);
		GLELoadProc(glVertexAttrib4usv_Impl,glVertexAttrib4usv,PFNGLVERTEXATTRIB4USVPROC);
		GLELoadProc(glVertexAttribPointer_Impl,glVertexAttribPointer,PFNGLVERTEXATTRIBPOINTERPROC);
		//GL_VERSION_2_1
		GLELoadProc(glUniformMatrix2x3fv_Impl,glUniformMatrix2x3fv,PFNGLUNIFORMMATRIX2X3FVPROC);
		GLELoadProc(glUniformMatrix2x4fv_Impl,glUniformMatrix2x4fv,PFNGLUNIFORMMATRIX2X4FVPROC);
		GLELoadProc(glUniformMatrix3x2fv_Impl,glUniformMatrix3x2fv,PFNGLUNIFORMMATRIX3X2FVPROC);
		GLELoadProc(glUniformMatrix3x4fv_Impl,glUniformMatrix3x4fv,PFNGLUNIFORMMATRIX3X4FVPROC);
		GLELoadProc(glUniformMatrix4x2fv_Impl,glUniformMatrix4x2fv,PFNGLUNIFORMMATRIX4X2FVPROC);
		GLELoadProc(glUniformMatrix4x3fv_Impl,glUniformMatrix4x3fv,PFNGLUNIFORMMATRIX4X3FVPROC);
		//GL_VERSION_3_0
		GLELoadProc(glBeginConditionalRender_Impl,glBeginConditionalRender,PFNGLBEGINCONDITIONALRENDERPROC);
		GLELoadProc(glBeginTransformFeedback_Impl,glBeginTransformFeedback,PFNGLBEGINTRANSFORMFEEDBACKPROC);
		GLELoadProc(glBindFragDataLocation_Impl,glBindFragDataLocation,PFNGLBINDFRAGDATALOCATIONPROC);
		GLELoadProc(glClampColor_Impl,glClampColor,PFNGLCLAMPCOLORPROC);
		GLELoadProc(glClearBufferfi_Impl,glClearBufferfi,PFNGLCLEARBUFFERFIPROC);
		GLELoadProc(glClearBufferfv_Impl,glClearBufferfv,PFNGLCLEARBUFFERFVPROC);
		GLELoadProc(glClearBufferiv_Impl,glClearBufferiv,PFNGLCLEARBUFFERIVPROC);
		GLELoadProc(glClearBufferuiv_Impl,glClearBufferuiv,PFNGLCLEARBUFFERUIVPROC);
		GLELoadProc(glColorMaski_Impl,glColorMaski,PFNGLCOLORMASKIPROC);
		GLELoadProc(glDisablei_Impl,glDisablei,PFNGLDISABLEIPROC);
		GLELoadProc(glEnablei_Impl,glEnablei,PFNGLENABLEIPROC);
		GLELoadProc(glEndConditionalRender_Impl,glEndConditionalRender,PFNGLENDCONDITIONALRENDERPROC);
		GLELoadProc(glEndTransformFeedback_Impl,glEndTransformFeedback,PFNGLENDTRANSFORMFEEDBACKPROC);
		GLELoadProc(glBindBufferRange_Impl,glBindBufferRange,PFNGLBINDBUFFERRANGEPROC);
		GLELoadProc(glBindBufferBase_Impl,glBindBufferBase,PFNGLBINDBUFFERBASEPROC);
		GLELoadProc(glGetBooleani_v_Impl,glGetBooleani_v,PFNGLGETBOOLEANI_VPROC);
		GLELoadProc(glGetIntegeri_v_Impl,glGetIntegeri_v,PFNGLGETINTEGERI_VPROC);
		GLELoadProc(glGetFragDataLocation_Impl,glGetFragDataLocation,PFNGLGETFRAGDATALOCATIONPROC);
		GLELoadProc(glGetStringi_Impl,glGetStringi,PFNGLGETSTRINGIPROC);
		GLELoadProc(glGetTexParameterIiv_Impl,glGetTexParameterIiv,PFNGLGETTEXPARAMETERIIVPROC);
		GLELoadProc(glGetTexParameterIuiv_Impl,glGetTexParameterIuiv,PFNGLGETTEXPARAMETERIUIVPROC);
		GLELoadProc(glGetTransformFeedbackVarying_Impl,glGetTransformFeedbackVarying,PFNGLGETTRANSFORMFEEDBACKVARYINGPROC);
		GLELoadProc(glGetUniformuiv_Impl,glGetUniformuiv,PFNGLGETUNIFORMUIVPROC);
		GLELoadProc(glGetVertexAttribIiv_Impl,glGetVertexAttribIiv,PFNGLGETVERTEXATTRIBIIVPROC);
		GLELoadProc(glGetVertexAttribIuiv_Impl,glGetVertexAttribIuiv,PFNGLGETVERTEXATTRIBIUIVPROC);
		GLELoadProc(glIsEnabledi_Impl,glIsEnabledi,PFNGLISENABLEDIPROC);
		GLELoadProc(glTexParameterIiv_Impl,glTexParameterIiv,PFNGLTEXPARAMETERIIVPROC);
		GLELoadProc(glTexParameterIuiv_Impl,glTexParameterIuiv,PFNGLTEXPARAMETERIUIVPROC);
		GLELoadProc(glTransformFeedbackVaryings_Impl,glTransformFeedbackVaryings,PFNGLTRANSFORMFEEDBACKVARYINGSPROC);
		GLELoadProc(glUniform1ui_Impl,glUniform1ui,PFNGLUNIFORM1UIPROC);
		GLELoadProc(glUniform1uiv_Impl,glUniform1uiv,PFNGLUNIFORM1UIVPROC);
		GLELoadProc(glUniform2ui_Impl,glUniform2ui,PFNGLUNIFORM2UIPROC);
		GLELoadProc(glUniform2uiv_Impl,glUniform2uiv,PFNGLUNIFORM2UIVPROC);
		GLELoadProc(glUniform3ui_Impl,glUniform3ui,PFNGLUNIFORM3UIPROC);
		GLELoadProc(glUniform3uiv_Impl,glUniform3uiv,PFNGLUNIFORM3UIVPROC);
		GLELoadProc(glUniform4ui_Impl,glUniform4ui,PFNGLUNIFORM4UIPROC);
		GLELoadProc(glUniform4uiv_Impl,glUniform4uiv,PFNGLUNIFORM4UIVPROC);
		GLELoadProc(glVertexAttribI1i_Impl,glVertexAttribI1i,PFNGLVERTEXATTRIBI1IPROC);
		GLELoadProc(glVertexAttribI1iv_Impl,glVertexAttribI1iv,PFNGLVERTEXATTRIBI1IVPROC);
		GLELoadProc(glVertexAttribI1ui_Impl,glVertexAttribI1ui,PFNGLVERTEXATTRIBI1UIPROC);
		GLELoadProc(glVertexAttribI1uiv_Impl,glVertexAttribI1uiv,PFNGLVERTEXATTRIBI1UIVPROC);
		GLELoadProc(glVertexAttribI2i_Impl,glVertexAttribI2i,PFNGLVERTEXATTRIBI2IPROC);
		GLELoadProc(glVertexAttribI2iv_Impl,glVertexAttribI2iv,PFNGLVERTEXATTRIBI2IVPROC);
		GLELoadProc(glVertexAttribI2ui_Impl,glVertexAttribI2ui,PFNGLVERTEXATTRIBI2UIPROC);
		GLELoadProc(glVertexAttribI2uiv_Impl,glVertexAttribI2uiv,PFNGLVERTEXATTRIBI2UIVPROC);
		GLELoadProc(glVertexAttribI3i_Impl,glVertexAttribI3i,PFNGLVERTEXATTRIBI3IPROC);
		GLELoadProc(glVertexAttribI3iv_Impl,glVertexAttribI3iv,PFNGLVERTEXATTRIBI3IVPROC);
		GLELoadProc(glVertexAttribI3ui_Impl,glVertexAttribI3ui,PFNGLVERTEXATTRIBI3UIPROC);
		GLELoadProc(glVertexAttribI3uiv_Impl,glVertexAttribI3uiv,PFNGLVERTEXATTRIBI3UIVPROC);
		GLELoadProc(glVertexAttribI4bv_Impl,glVertexAttribI4bv,PFNGLVERTEXATTRIBI4BVPROC);
		GLELoadProc(glVertexAttribI4i_Impl,glVertexAttribI4i,PFNGLVERTEXATTRIBI4IPROC);
		GLELoadProc(glVertexAttribI4iv_Impl,glVertexAttribI4iv,PFNGLVERTEXATTRIBI4IVPROC);
		GLELoadProc(glVertexAttribI4sv_Impl,glVertexAttribI4sv,PFNGLVERTEXATTRIBI4SVPROC);
		GLELoadProc(glVertexAttribI4ubv_Impl,glVertexAttribI4ubv,PFNGLVERTEXATTRIBI4UBVPROC);
		GLELoadProc(glVertexAttribI4ui_Impl,glVertexAttribI4ui,PFNGLVERTEXATTRIBI4UIPROC);
		GLELoadProc(glVertexAttribI4uiv_Impl,glVertexAttribI4uiv,PFNGLVERTEXATTRIBI4UIVPROC);
		GLELoadProc(glVertexAttribI4usv_Impl,glVertexAttribI4usv,PFNGLVERTEXATTRIBI4USVPROC);
		GLELoadProc(glVertexAttribIPointer_Impl,glVertexAttribIPointer,PFNGLVERTEXATTRIBIPOINTERPROC);
		//GL_VERSION_3_1
		GLELoadProc(glDrawArraysInstanced_Impl,glDrawArraysInstanced,PFNGLDRAWARRAYSINSTANCEDPROC);
		GLELoadProc(glDrawElementsInstanced_Impl,glDrawElementsInstanced,PFNGLDRAWELEMENTSINSTANCEDPROC);
		GLELoadProc(glPrimitiveRestartIndex_Impl,glPrimitiveRestartIndex,PFNGLPRIMITIVERESTARTINDEXPROC);
		GLELoadProc(glTexBuffer_Impl,glTexBuffer,PFNGLTEXBUFFERPROC);
		//GL_VERSION_3_2
		GLELoadProc(glFramebufferTexture_Impl,glFramebufferTexture,PFNGLFRAMEBUFFERTEXTUREPROC);
		GLELoadProc(glGetBufferParameteri64v_Impl,glGetBufferParameteri64v,PFNGLGETBUFFERPARAMETERI64VPROC);
		GLELoadProc(glGetInteger64i_v_Impl,glGetInteger64i_v,PFNGLGETINTEGER64I_VPROC);
		//GL_VERSION_3_3
		GLELoadProc(glVertexAttribDivisor_Impl,glVertexAttribDivisor,PFNGLVERTEXATTRIBDIVISORPROC);
		//GL_VERSION_4_0
		GLELoadProc(glBlendEquationSeparatei_Impl,glBlendEquationSeparatei,PFNGLBLENDEQUATIONSEPARATEIPROC);
		GLELoadProc(glBlendEquationi_Impl,glBlendEquationi,PFNGLBLENDEQUATIONIPROC);
		GLELoadProc(glBlendFuncSeparatei_Impl,glBlendFuncSeparatei,PFNGLBLENDFUNCSEPARATEIPROC);
		GLELoadProc(glBlendFunci_Impl,glBlendFunci,PFNGLBLENDFUNCIPROC);
		GLELoadProc(glMinSampleShading_Impl,glMinSampleShading,PFNGLMINSAMPLESHADINGPROC);
		//GL_AMD_debug_output
		GLELoadProc(glDebugMessageCallbackAMD_Impl,glDebugMessageCallbackAMD,PFNGLDEBUGMESSAGECALLBACKAMDPROC);
		GLELoadProc(glDebugMessageEnableAMD_Impl,glDebugMessageEnableAMD,PFNGLDEBUGMESSAGEENABLEAMDPROC);
		GLELoadProc(glDebugMessageInsertAMD_Impl,glDebugMessageInsertAMD,PFNGLDEBUGMESSAGEINSERTAMDPROC);
		GLELoadProc(glGetDebugMessageLogAMD_Impl,glGetDebugMessageLogAMD,PFNGLGETDEBUGMESSAGELOGAMDPROC);
		...
		// GL_ARB_debug_output
		GLELoadProc(glDebugMessageCallbackARB_Impl, glDebugMessageCallbackARB,PFNGLDEBUGMESSAGECALLBACKARBPROC);
		GLELoadProc(glDebugMessageControlARB_Impl, glDebugMessageControlARB,PFNGLDEBUGMESSAGECONTROLARBPROC);
		GLELoadProc(glDebugMessageInsertARB_Impl, glDebugMessageInsertARB,PFNGLDEBUGMESSAGEINSERTARBPROC);
		GLELoadProc(glGetDebugMessageLogARB_Impl, glGetDebugMessageLogARB,PFNGLGETDEBUGMESSAGELOGARBPROC);

		// GL_ARB_ES2_compatibility
		GLELoadProc(glClearDepthf_Impl, glClearDepthf,PFNGLCLEARDEPTHFPROC);
		GLELoadProc(glDepthRangef_Impl, glDepthRangef,PFNGLDEPTHRANGEFPROC);
		GLELoadProc(glGetShaderPrecisionFormat_Impl, glGetShaderPrecisionFormat,PFNGLGETSHADERPRECISIONFORMATPROC);
		GLELoadProc(glReleaseShaderCompiler_Impl, glReleaseShaderCompiler,PFNGLRELEASESHADERCOMPILERPROC);
		GLELoadProc(glShaderBinary_Impl, glShaderBinary,PFNGLSHADERBINARYPROC);

		// GL_ARB_framebuffer_object
		GLELoadProc(glBindFramebuffer_Impl, glBindFramebuffer,PFNGLBINDFRAMEBUFFERPROC);
		GLELoadProc(glBindRenderbuffer_Impl, glBindRenderbuffer,PFNGLBINDRENDERBUFFERPROC);
		GLELoadProc(glBlitFramebuffer_Impl, glBlitFramebuffer,PFNGLBLITFRAMEBUFFERPROC);
		GLELoadProc(glCheckFramebufferStatus_Impl, glCheckFramebufferStatus,PFNGLCHECKFRAMEBUFFERSTATUSPROC);
		GLELoadProc(glDeleteFramebuffers_Impl, glDeleteFramebuffers,PFNGLDELETEFRAMEBUFFERSPROC);
		GLELoadProc(glDeleteRenderbuffers_Impl, glDeleteRenderbuffers,PFNGLDELETERENDERBUFFERSPROC);
		GLELoadProc(glFramebufferRenderbuffer_Impl, glFramebufferRenderbuffer,PFNGLFRAMEBUFFERRENDERBUFFERPROC);
		GLELoadProc(glFramebufferTexture1D_Impl, glFramebufferTexture1D,PFNGLFRAMEBUFFERTEXTURE1DPROC);
		GLELoadProc(glFramebufferTexture2D_Impl, glFramebufferTexture2D,PFNGLFRAMEBUFFERTEXTURE2DPROC);
		GLELoadProc(glFramebufferTexture3D_Impl, glFramebufferTexture3D,PFNGLFRAMEBUFFERTEXTURE3DPROC);
		GLELoadProc(glFramebufferTextureLayer_Impl, glFramebufferTextureLayer,PFNGLFRAMEBUFFERTEXTURELAYERPROC);
		GLELoadProc(glGenFramebuffers_Impl, glGenFramebuffers,PFNGLGENFRAMEBUFFERSPROC);
		GLELoadProc(glGenRenderbuffers_Impl, glGenRenderbuffers,PFNGLGENRENDERBUFFERSPROC);
		GLELoadProc(glGenerateMipmap_Impl, glGenerateMipmap,PFNGLGENERATEMIPMAPPROC);
		GLELoadProc(glGetFramebufferAttachmentParameteriv_Impl, glGetFramebufferAttachmentParameteriv,PFNGLGETFRAMEBUFFERATTACHMENTPARAMETERIVPROC);
		GLELoadProc(glGetRenderbufferParameteriv_Impl, glGetRenderbufferParameteriv,PFNGLGETRENDERBUFFERPARAMETERIVPROC);
		GLELoadProc(glIsFramebuffer_Impl, glIsFramebuffer,PFNGLISFRAMEBUFFERPROC);
		GLELoadProc(glIsRenderbuffer_Impl, glIsRenderbuffer,PFNGLISRENDERBUFFERPROC);
		GLELoadProc(glRenderbufferStorage_Impl, glRenderbufferStorage,PFNGLRENDERBUFFERSTORAGEPROC);
		GLELoadProc(glRenderbufferStorageMultisample_Impl, glRenderbufferStorageMultisample,PFNGLRENDERBUFFERSTORAGEMULTISAMPLEPROC);

		// GL_ARB_texture_multisample
		GLELoadProc(glGetMultisamplefv_Impl, glGetMultisamplefv,PFNGLGETMULTISAMPLEFVPROC);
		GLELoadProc(glSampleMaski_Impl, glSampleMaski,PFNGLSAMPLEMASKIPROC);
		GLELoadProc(glTexImage2DMultisample_Impl, glTexImage2DMultisample,PFNGLTEXIMAGE2DMULTISAMPLEPROC);
		GLELoadProc(glTexImage3DMultisample_Impl, glTexImage3DMultisample,PFNGLTEXIMAGE3DMULTISAMPLEPROC);
        ...
        if(!glBindFramebuffer_Impl) // This will rarely if ever be the case in practice with modern computers and drivers.
        {
            ...
            GLELoadProc(glBindFramebuffer_Impl, glBindFramebufferEXT, PFNGLBINDFRAMEBUFFERPROC);
            GLELoadProc(glBindRenderbuffer_Impl, glBindRenderbufferEXT, PFNGLBINDRENDERBUFFERPROC);
          //GLELoadProc(glBlitFramebuffer_Impl, glBlitFramebufferEXT (nonexistent));
            GLELoadProc(glCheckFramebufferStatus_Impl, glCheckFramebufferStatusEXT, PFNGLCHECKFRAMEBUFFERSTATUSPROC);
            GLELoadProc(glDeleteFramebuffers_Impl, glDeleteFramebuffersEXT, PFNGLDELETEFRAMEBUFFERSPROC);
            GLELoadProc(glDeleteRenderbuffers_Impl, glDeleteRenderbuffersEXT, PFNGLDELETERENDERBUFFERSPROC);
            GLELoadProc(glFramebufferRenderbuffer_Impl, glFramebufferRenderbufferEXT, PFNGLFRAMEBUFFERRENDERBUFFERPROC);
            GLELoadProc(glFramebufferTexture1D_Impl, glFramebufferTexture1DEXT, PFNGLFRAMEBUFFERTEXTURE1DPROC);
            GLELoadProc(glFramebufferTexture2D_Impl, glFramebufferTexture2DEXT, PFNGLFRAMEBUFFERTEXTURE2DPROC);
            GLELoadProc(glFramebufferTexture3D_Impl, glFramebufferTexture3DEXT, PFNGLFRAMEBUFFERTEXTURE3DPROC);
          //GLELoadProc(glFramebufferTextureLayer_Impl, glFramebufferTextureLayerEXT (nonexistent));
            GLELoadProc(glGenFramebuffers_Impl, glGenFramebuffersEXT, PFNGLGENFRAMEBUFFERSPROC);
            GLELoadProc(glGenRenderbuffers_Impl, glGenRenderbuffersEXT, PFNGLGENRENDERBUFFERSPROC);
            GLELoadProc(glGenerateMipmap_Impl, glGenerateMipmapEXT, PFNGLGENERATEMIPMAPPROC);
            GLELoadProc(glGetFramebufferAttachmentParameteriv_Impl, glGetFramebufferAttachmentParameterivEXT, PFNGLGETFRAMEBUFFERATTACHMENTPARAMETERIVPROC);
            GLELoadProc(glGetRenderbufferParameteriv_Impl, glGetRenderbufferParameterivEXT, PFNGLGETRENDERBUFFERPARAMETERIVPROC);
            GLELoadProc(glIsFramebuffer_Impl, glIsFramebufferEXT, PFNGLISFRAMEBUFFERPROC);
            GLELoadProc(glIsRenderbuffer_Impl, glIsRenderbufferEXT, PFNGLISRENDERBUFFERPROC);
            GLELoadProc(glRenderbufferStorage_Impl, glRenderbufferStorageEXT, PFNGLRENDERBUFFERSTORAGEPROC);
		...
		GLELoadProc(glTexImage3DMultisample_Impl, glTexImage3DMultisample,PFNGLTEXIMAGE3DMULTISAMPLEPROC);
		// GL_ARB_timer_query
		GLELoadProc(glGetQueryObjecti64v_Impl, glGetQueryObjecti64v,PFNGLGETQUERYOBJECTI64VPROC);
		GLELoadProc(glGetQueryObjectui64v_Impl, glGetQueryObjectui64v,PFNGLGETQUERYOBJECTUI64VPROC);
		GLELoadProc(glQueryCounter_Impl, glQueryCounter,PFNGLQUERYCOUNTERPROC);
		// GL_ARB_vertex_array_object
		GLELoadProc(glBindVertexArray_Impl, glBindVertexArray,PFNGLBINDVERTEXARRAYPROC);
		GLELoadProc(glDeleteVertexArrays_Impl, glDeleteVertexArrays,PFNGLDELETEVERTEXARRAYSPROC);
		GLELoadProc(glGenVertexArrays_Impl, glGenVertexArrays,PFNGLGENVERTEXARRAYSPROC);
		GLELoadProc(glIsVertexArray_Impl, glIsVertexArray,PFNGLISVERTEXARRAYPROC);
		...
		GLELoadProc(glColorMaskIndexedEXT_Impl, glColorMaskIndexedEXT,PFNGLCOLORMASKINDEXEDEXTPROC);
		GLELoadProc(glDisableIndexedEXT_Impl, glDisableIndexedEXT,PFNGLDISABLEINDEXEDEXTPROC);
		GLELoadProc(glEnableIndexedEXT_Impl, glEnableIndexedEXT,PFNGLENABLEINDEXEDEXTPROC);
		GLELoadProc(glGetBooleanIndexedvEXT_Impl, glGetBooleanIndexedvEXT,PFNGLGETBOOLEANINDEXEDVEXTPROC);
		GLELoadProc(glGetIntegerIndexedvEXT_Impl, glGetIntegerIndexedvEXT,PFNGLGETINTEGERINDEXEDVEXTPROC);
		GLELoadProc(glIsEnabledIndexedEXT_Impl, glIsEnabledIndexedEXT,PFNGLISENABLEDINDEXEDEXTPROC);
		// GL_KHR_debug
		GLELoadProc(glDebugMessageCallback_Impl, glDebugMessageCallback,PFNGLDEBUGMESSAGECALLBACKPROC);
		GLELoadProc(glDebugMessageControl_Impl, glDebugMessageControl,PFNGLDEBUGMESSAGECONTROLPROC);
		GLELoadProc(glDebugMessageInsert_Impl, glDebugMessageInsert,PFNGLDEBUGMESSAGEINSERTPROC);
		GLELoadProc(glGetDebugMessageLog_Impl, glGetDebugMessageLog,PFNGLGETDEBUGMESSAGELOGPROC);
		GLELoadProc(glGetObjectLabel_Impl, glGetObjectLabel,PFNGLGETOBJECTLABELPROC);
		GLELoadProc(glGetObjectPtrLabel_Impl, glGetObjectPtrLabel,PFNGLGETOBJECTPTRLABELPROC);
		GLELoadProc(glObjectLabel_Impl, glObjectLabel,PFNGLOBJECTLABELPROC);
		GLELoadProc(glObjectPtrLabel_Impl, glObjectPtrLabel,PFNGLOBJECTPTRLABELPROC);
		GLELoadProc(glPopDebugGroup_Impl, glPopDebugGroup,PFNGLPOPDEBUGGROUPPROC);
		GLELoadProc(glPushDebugGroup_Impl, glPushDebugGroup,PFNGLPUSHDEBUGGROUPPROC);
		// GL_WIN_swap_hint
		GLELoadProc(glAddSwapHintRectWIN_Impl, glAddSwapHintRectWIN,PFNGLADDSWAPHINTRECTWINPROC);
    }
    ...
    void OVR::GLEContext::InitPlatformExtensionLoad()
    {
            ...
            GLELoadProc(wglCreateBufferRegionARB_Impl, wglCreateBufferRegionARB, PFNWGLCREATEBUFFERREGIONARBPROC);
            GLELoadProc(wglDeleteBufferRegionARB_Impl, wglDeleteBufferRegionARB, PFNWGLDELETEBUFFERREGIONARBPROC);
            GLELoadProc(wglSaveBufferRegionARB_Impl, wglSaveBufferRegionARB, PFNWGLSAVEBUFFERREGIONARBPROC);
            GLELoadProc(wglRestoreBufferRegionARB_Impl, wglRestoreBufferRegionARB, PFNWGLRESTOREBUFFERREGIONARBPROC);

            // WGL_ARB_extensions_string
            GLELoadProc(wglGetExtensionsStringARB_Impl, wglGetExtensionsStringARB, PFNWGLGETEXTENSIONSSTRINGARBPROC);

            // WGL_ARB_pixel_format
            GLELoadProc(wglGetPixelFormatAttribivARB_Impl, wglGetPixelFormatAttribivARB, PFNWGLGETPIXELFORMATATTRIBIVARBPROC);
            GLELoadProc(wglGetPixelFormatAttribfvARB_Impl, wglGetPixelFormatAttribfvARB, PFNWGLGETPIXELFORMATATTRIBFVARBPROC);
            GLELoadProc(wglChoosePixelFormatARB_Impl, wglChoosePixelFormatARB, PFNWGLCHOOSEPIXELFORMATARBPROC);

            // WGL_ARB_make_current_read
            GLELoadProc(wglMakeContextCurrentARB_Impl, wglMakeContextCurrentARB, PFNWGLMAKECONTEXTCURRENTARBPROC);
            GLELoadProc(wglGetCurrentReadDCARB_Impl, wglGetCurrentReadDCARB, PFNWGLGETCURRENTREADDCARBPROC);

            // WGL_ARB_pbuffer
            GLELoadProc(wglCreatePbufferARB_Impl, wglCreatePbufferARB, PFNWGLCREATEPBUFFERARBPROC);
            GLELoadProc(wglGetPbufferDCARB_Impl, wglGetPbufferDCARB, PFNWGLGETPBUFFERDCARBPROC);
            GLELoadProc(wglReleasePbufferDCARB_Impl, wglReleasePbufferDCARB, PFNWGLRELEASEPBUFFERDCARBPROC);
            GLELoadProc(wglDestroyPbufferARB_Impl, wglDestroyPbufferARB, PFNWGLDESTROYPBUFFERARBPROC);
            GLELoadProc(wglQueryPbufferARB_Impl, wglQueryPbufferARB, PFNWGLQUERYPBUFFERARBPROC);

            // WGL_ARB_render_texture
            GLELoadProc(wglBindTexImageARB_Impl, wglBindTexImageARB, PFNWGLBINDTEXIMAGEARBPROC);
            GLELoadProc(wglReleaseTexImageARB_Impl, wglReleaseTexImageARB, PFNWGLRELEASETEXIMAGEARBPROC);
            GLELoadProc(wglSetPbufferAttribARB_Impl, wglSetPbufferAttribARB, PFNWGLSETPBUFFERATTRIBARBPROC);

            // WGL_NV_present_video
            GLELoadProc(wglEnumerateVideoDevicesNV_Impl, wglEnumerateVideoDevicesNV, PFNWGLENUMERATEVIDEODEVICESNVPROC);
            GLELoadProc(wglBindVideoDeviceNV_Impl, wglBindVideoDeviceNV, PFNWGLBINDVIDEODEVICENVPROC);
            GLELoadProc(wglQueryCurrentContextNV_Impl, wglQueryCurrentContextNV, PFNWGLQUERYCURRENTCONTEXTNVPROC);

            // WGL_ARB_create_context
            GLELoadProc(wglCreateContextAttribsARB_Impl, wglCreateContextAttribsARB, PFNWGLCREATECONTEXTATTRIBSARBPROC);

            // WGL_EXT_extensions_string
            GLELoadProc(wglGetExtensionsStringEXT_Impl, wglGetExtensionsStringEXT, PFNWGLGETEXTENSIONSSTRINGEXTPROC);

            // WGL_EXT_swap_control
            GLELoadProc(wglGetSwapIntervalEXT_Impl, wglGetSwapIntervalEXT, PFNWGLGETSWAPINTERVALEXTPROC);
            GLELoadProc(wglSwapIntervalEXT_Impl, wglSwapIntervalEXT, PFNWGLSWAPINTERVALEXTPROC);
        
            // WGL_OML_sync_control
            GLELoadProc(wglGetSyncValuesOML_Impl, wglGetSyncValuesOML, PFNWGLGETSYNCVALUESOMLPROC);
            GLELoadProc(wglGetMscRateOML_Impl, wglGetMscRateOML, PFNWGLGETMSCRATEOMLPROC);
            GLELoadProc(wglSwapBuffersMscOML_Impl, wglSwapBuffersMscOML, PFNWGLSWAPBUFFERSMSCOMLPROC);
            GLELoadProc(wglSwapLayerBuffersMscOML_Impl, wglSwapLayerBuffersMscOML, PFNWGLSWAPLAYERBUFFERSMSCOMLPROC);
            GLELoadProc(wglWaitForMscOML_Impl, wglWaitForMscOML, PFNWGLWAITFORMSCOMLPROC);
            GLELoadProc(wglWaitForSbcOML_Impl, wglWaitForSbcOML, PFNWGLWAITFORSBCOMLPROC);

            // WGL_NV_video_output
            GLELoadProc(wglGetVideoDeviceNV_Impl, wglGetVideoDeviceNV, PFNWGLGETVIDEODEVICENVPROC);
            GLELoadProc(wglReleaseVideoDeviceNV_Impl, wglReleaseVideoDeviceNV, PFNWGLRELEASEVIDEODEVICENVPROC);
            GLELoadProc(wglBindVideoImageNV_Impl, wglBindVideoImageNV, PFNWGLBINDVIDEOIMAGENVPROC);
            GLELoadProc(wglReleaseVideoImageNV_Impl, wglReleaseVideoImageNV, PFNWGLRELEASEVIDEOIMAGENVPROC);
            GLELoadProc(wglSendPbufferToVideoNV_Impl, wglSendPbufferToVideoNV, PFNWGLSENDPBUFFERTOVIDEONVPROC);
            GLELoadProc(wglGetVideoInfoNV_Impl, wglGetVideoInfoNV, PFNWGLGETVIDEOINFONVPROC);

            // WGL_NV_swap_group
            GLELoadProc(wglJoinSwapGroupNV_Impl, wglJoinSwapGroupNV, PFNWGLJOINSWAPGROUPNVPROC);
            GLELoadProc(wglBindSwapBarrierNV_Impl, wglBindSwapBarrierNV, PFNWGLBINDSWAPBARRIERNVPROC);
            GLELoadProc(wglQuerySwapGroupNV_Impl, wglQuerySwapGroupNV, PFNWGLQUERYSWAPGROUPNVPROC);
            GLELoadProc(wglQueryMaxSwapGroupsNV_Impl, wglQueryMaxSwapGroupsNV, PFNWGLQUERYMAXSWAPGROUPSNVPROC);
            GLELoadProc(wglQueryFrameCountNV_Impl, wglQueryFrameCountNV, PFNWGLQUERYFRAMECOUNTNVPROC);
            GLELoadProc(wglResetFrameCountNV_Impl, wglResetFrameCountNV, PFNWGLRESETFRAMECOUNTNVPROC);

            // WGL_NV_video_capture
            GLELoadProc(wglBindVideoCaptureDeviceNV_Impl, wglBindVideoCaptureDeviceNV, PFNWGLBINDVIDEOCAPTUREDEVICENVPROC);
            GLELoadProc(wglEnumerateVideoCaptureDevicesNV_Impl, wglEnumerateVideoCaptureDevicesNV, PFNWGLENUMERATEVIDEOCAPTUREDEVICESNVPROC);
            GLELoadProc(wglLockVideoCaptureDeviceNV_Impl, wglLockVideoCaptureDeviceNV, PFNWGLLOCKVIDEOCAPTUREDEVICENVPROC);
            GLELoadProc(wglQueryVideoCaptureDeviceNV_Impl, wglQueryVideoCaptureDeviceNV, PFNWGLQUERYVIDEOCAPTUREDEVICENVPROC);
            GLELoadProc(wglReleaseVideoCaptureDeviceNV_Impl, wglReleaseVideoCaptureDeviceNV, PFNWGLRELEASEVIDEOCAPTUREDEVICENVPROC);

            // WGL_NV_copy_image
            GLELoadProc(wglCopyImageSubDataNV_Impl, wglCopyImageSubDataNV, PFNWGLCOPYIMAGESUBDATANVPROC);

            // WGL_NV_DX_interop
            GLELoadProc(wglDXCloseDeviceNV_Impl, wglDXCloseDeviceNV, PFNWGLDXCLOSEDEVICENVPROC);
            GLELoadProc(wglDXLockObjectsNV_Impl, wglDXLockObjectsNV, PFNWGLDXLOCKOBJECTSNVPROC);
            GLELoadProc(wglDXObjectAccessNV_Impl, wglDXObjectAccessNV, PFNWGLDXOBJECTACCESSNVPROC);
            GLELoadProc(wglDXOpenDeviceNV_Impl, wglDXOpenDeviceNV, PFNWGLDXOPENDEVICENVPROC);
            GLELoadProc(wglDXRegisterObjectNV_Impl, wglDXRegisterObjectNV, PFNWGLDXREGISTEROBJECTNVPROC);
            GLELoadProc(wglDXSetResourceShareHandleNV_Impl, wglDXSetResourceShareHandleNV, PFNWGLDXSETRESOURCESHAREHANDLENVPROC);
            GLELoadProc(wglDXUnlockObjectsNV_Impl, wglDXUnlockObjectsNV, PFNWGLDXUNLOCKOBJECTSNVPROC);
            GLELoadProc(wglDXUnregisterObjectNV_Impl, wglDXUnregisterObjectNV, PFNWGLDXUNREGISTEROBJECTNVPROC);
