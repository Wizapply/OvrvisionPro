...
rem %XPERF% -start OVRKernelLogger -on %TRACE_OVR_KERNEL% %TRACE_STAND_BUFFERS% -f "%TRACEDIR%\OVRKernel.etl"
rem %XPERF% -start OVRRTFilterLogger -on %TRACE_OVR_RTFILTER% %TRACE_STAND_BUFFERS% -f "%TRACEDIR%\OVRRTFilter.etl"
%XPERF% -start OVRUSBVidLogger -on %TRACE_OVR_USBVID% %TRACE_STAND_BUFFERS% -f "%TRACEDIR%\OVRUSBVid.etl"
rem %XPERF% -start OVRCompositorLogger -on %TRACE_OVR_COMPOSITOR% %TRACE_STAND_BUFFERS% -f "%TRACEDIR%\OVRCompositor.etl"
...
%XPERF% -stop XAMLLogger DxTest OLogger MFLogger DxLogger DxcStackLogger DxcLogger UMDLogger DXGILogger Dx11Logger D3D10Level9Logger D2DLogger D2DScenariosLogger OVRUSBVidLogger OVRLibLogger NVLogger AMDLogger
echo Starting merge...
%XPERF% -merge "%TRACEDIR%\XAML.etl" "%TRACEDIR%\Other.etl" "%TRACEDIR%\MF.etl" "%TRACEDIR%\DX.etl" "%TRACEDIR%\DXC.etl" "%TRACEDIR%\DXCStacks.etl" "%TRACEDIR%\DxcState.etl" "%TRACEDIR%\UMD.etl" "%TRACEDIR%\DXGI.etl" "%TRACEDIR%\DX11.etl" "%TRACEDIR%\D3D10level9.etl" "%TRACEDIR%\kernel.etl" "%TRACEDIR%\DxTest.etl" "%TRACEDIR%\D2D.etl" "%TRACEDIR%\D2DScenarios.etl" "%TRACEDIR%\OVRUSBVid.etl" "%TRACEDIR%\OVRLib.etl" "%TRACEDIR%\NV.etl" "%TRACEDIR%\AMD.etl" "%TRACEDIR%\Merged.etl"
goto MergeDone
