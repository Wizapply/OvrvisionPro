...
"		hsv.z = v;\n"
"		hsv.y = (delta * 255) / v;\n"
"		if (v == pixel.z) { hue = (30 * ((int)pixel.y - (int)pixel.x)) / delta; }\n"
"		else if (v == pixel.y) { hue = (30 * ((int)pixel.x - (int)pixel.z)) / delta + 60; }\n"
"		else { hue = (30 * ((int)pixel.z - (int)pixel.y)) / delta + 120; }\n"
