...
"	uint delta = v - min(min(pixel.x, pixel.y), pixel.z);\n"
"	if (v == 0) { hsv.x = hsv.y = hsv.z = 0; }\n"
"	else {\n"
"		hsv.z = v;\n"
"		hsv.y = (delta * 255) / v;\n"
"		if (v == pixel.x) { hue = (30 * ((int)pixel.y - (int)pixel.z)) / delta; }\n"
"		else if (v == pixel.y) { hue = (30 * ((int)pixel.z - (int)pixel.x)) / delta + 60; }\n"
"		else { hue = (30 * ((int)pixel.x - (int)pixel.y)) / delta + 120; }\n"
"		if (hue < 0) { hsv.x = (uint)(hue + 180); }\n"
"		else { hsv.x = (uint)hue; }\n"
"	}\n"
